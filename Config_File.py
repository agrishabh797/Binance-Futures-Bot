...
order_Size = 10  ## As % of account, i.e 2.5 = 2.5%
leverage = 10
...
Max_Number_Of_Trades = 2  ## How many positions we can have open at once
...
symbol = ['BTCBUSD', 'DODOBUSD', 'LEVERBUSD', 'CVXBUSD', 'SANDBUSD', 'DOTBUSD', 'ADABUSD', 'APTBUSD', 'GALABUSD', 'LINKBUSD', 'MATICBUSD', 'TLMBUSD', 'XRPBUSD', '1000SHIBBUSD', 'ETCBUSD', 'WAVESBUSD', 'ETHBUSD', 'AVAXBUSD', 'LUNA2BUSD', 'SOLBUSD', 'AMBBUSD', 'FTMBUSD', 'LTCBUSD', 'PHBBUSD', 'NEARBUSD', 'ICPBUSD', 'FILBUSD', 'GMTBUSD', 'TRXBUSD', 'GALBUSD', 'APEBUSD', '1000LUNCBUSD', 'BNBBUSD', 'DOGEBUSD', 'LDOBUSD', 'UNIBUSD']  ## If Trade_All_Coins is False then we list the coins we want to trade here, otherwise the bot will automatically get all coins and trade them
